...
class TaxonomyController extends BaseModelController<typeof TaxonomyDAO, TaxonomyModel, TaxonomyFDTO>{

}


const controller = new TaxonomyController(TaxonomyDAO, TaxonomyModel, TaxonomyFDTO)
